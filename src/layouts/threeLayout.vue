      ...
      <template #header>
        <h-app-toolbar bg-color="bg-primary">
          <h-app-toolbar-container>
            ...
            <h-image avatar src="img/icons/threejs.png" size="42px"/>
    ...
    <template #left>
      <div class="col-auto text-center h-pa-md">
        <div class="column align-items-center">
          <h-image avatar src="img/icons/threejs.png" size="64px"/>
          <div class="">WEBGL</div>
        </div>
      </div>
      <div class="col">
        <h-list>
          ...
          <h-list-item @click="$router.push('/threejs/cube')">
            <h-list-item-content>
      ...
      <div class="col-auto">
        <div class="text-center h-pa-md">
          <h2 class="no-margin">Vue WEBGL</h2>
        </div>
      </div>
